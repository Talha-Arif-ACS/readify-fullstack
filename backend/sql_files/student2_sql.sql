-- Readify Database Schema - Student 2 (Books, Orders & Wishlists)
...
-- Physical Books from Catalog Page from id 1-27
...
-- eBooks from eBooks Page from id 28-37
...
-- Audio Books from Audiobooks Page from id 38-47
